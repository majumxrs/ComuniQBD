...
namespace ComuniQBD.Migrations
{
    ...
    [Migration("20241022133340_AlteraçaoDasFotos")]
    partial class AlteraçaoDasFotos
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ComuniQBD.Models.Usuario", b =>
                {
                    ...
                    b.Property<string>("UsuarioBairro")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("UsuarioBairro");

                    b.Property<string>("UsuarioCEP")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)")
            ...
            modelBuilder.Entity("ComuniQBD.Models.Usuario", b =>
                {
                    b.HasOne("ComuniQBD.Models.TipoPerfil", "TipoPerfil")
                        .WithMany()
